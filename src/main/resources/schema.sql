CREATE TABLE IF NOT EXISTS app_info (
    ...
    app_type TINYINT NOT NULL DEFAULT 1 COMMENT '1=Android 2=鸿蒙',
    app_description VARCHAR(512) DEFAULT NULL COMMENT '应用描述',
    copyright_no VARCHAR(100) DEFAULT NULL COMMENT '软著登记号',
...
CREATE TABLE IF NOT EXISTS app_release_record (
    ...
    store_type VARCHAR(20) NOT NULL COMMENT '应用商店类型',
    release_mode VARCHAR(20) NOT NULL DEFAULT 'api' COMMENT '发版方式',
    ...
    release_status VARCHAR(20) NOT NULL DEFAULT 'draft' COMMENT '发版状态',
    store_release_id VARCHAR(100) DEFAULT NULL COMMENT '商店侧发版 ID',
