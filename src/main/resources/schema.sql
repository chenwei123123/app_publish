...
CREATE TABLE IF NOT EXISTS app_release_record (
    ...
    release_type  BIGINT NOT NULL DEFAULT '1' COMMENT '发布类型：1全量 2分阶段发布',
    gray_percent BIGINT DEFAULT NULL COMMENT '当前灰度比例',
    gray_start_time DATETIME DEFAULT NULL COMMENT '分阶段开始时间',
    gray_end_time DATETIME DEFAULT NULL COMMENT '分阶段结束时间',
    auto_full BIGINT NOT NULL DEFAULT '1' COMMENT '到期自动全量：0否 1是',
