...
CREATE TABLE IF NOT EXISTS app_store_config (
    ...
    privacy_url VARCHAR(255) DEFAULT NULL COMMENT 'Xiaomi privacy policy URL',
    icon LONGTEXT DEFAULT NULL COMMENT 'Xiaomi icon in Base64',
    app_id VARCHAR(100) DEFAULT NULL COMMENT 'Yingyongbao appId or Sanxing contentId',
